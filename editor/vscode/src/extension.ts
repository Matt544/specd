...
let delimDecoration!: vscode.TextEditorDecorationType;
let contentDecoration!: vscode.TextEditorDecorationType;
let placeholderDecoration!: vscode.TextEditorDecorationType;
...
function updateDecorations(editor: vscode.TextEditor): void {
    ...
    const delimRanges: vscode.Range[] = [];
    const contentRanges: vscode.Range[] = [];
    const placeholderRanges: vscode.Range[] = [];
    ...
    for (let line = 0; line < doc.lineCount; line++) {
        ...
        while ((placeholderMatch = PLACEHOLDER_RE.exec(text)) !== null) {
            ...
            placeholderRanges.push(new vscode.Range(
                new vscode.Position(line, matchStart),
                new vscode.Position(line, openEnd),
            ));
            placeholderRanges.push(new vscode.Range(
                new vscode.Position(line, contentEnd),
                new vscode.Position(line, closeEnd),
            ));
        }
        ...
        while ((codeMatch = INLINE_CODE_RE.exec(text)) !== null) {
            ...
            while ((jinjaMatch = JINJA_PARTS_RE.exec(spanContent)) !== null) {
                ...
                delimRanges.push(new vscode.Range(
                    new vscode.Position(line, matchStart),
                    new vscode.Position(line, openEnd),
                ));
                contentRanges.push(new vscode.Range(
                    new vscode.Position(line, openEnd),
                    new vscode.Position(line, contentEnd),
                ));
                delimRanges.push(new vscode.Range(
